...
/* package cohomolo-gy-0.1.0.0 */
#define VERSION_cohomolo_gy "0.1.0.0"
#define MIN_VERSION_cohomolo_gy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hakyll-4.9.5.1 */
#define VERSION_hakyll "4.9.5.1"
#define MIN_VERSION_hakyll(major1,major2,minor) (\
  (major1) <  4 || \
  (major1) == 4 && (major2) <  9 || \
  (major1) == 4 && (major2) == 9 && (minor) <= 5)
...
#define CURRENT_COMPONENT_ID "cohomolo-gy-0.1.0.0"

#define CURRENT_PACKAGE_KEY "cohomolo-gy-0.1.0.0"
